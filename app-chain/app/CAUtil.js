...
exports.registerAndEnrollUserV2 = async (caClient, wallet, orgMspId, userId, affiliation) => {
	let res ;
	try {
		// Check to see if we've already enrolled the user
		const userIdentity = await wallet.get(userId);
...
// exports.registerAndEnrollSupervisor = async (caClient, wallet, orgMspId, userId, affiliation) => {
// 	try {
// 		// Check to see if we've already enrolled the user
// 		const userIdentity = await wallet.get(userId);
// 		if (userIdentity) {
...
// 			enrollmentID: userId,
// 			role: 'supervisor',
// 			attrs: [{ "name" : "regist_msp", "value" : orgMspId }]
// 		}, adminUser);
// 		const enrollment = await caClient.enroll({
// 			enrollmentID: userId,
// 			enrollmentSecret: secret,
// 			attr_reqs: [{ "name": "regist_msp"}]
// 		});
// 		const x509Identity = {
// 			credentials: {
// 				certificate: enrollment.certificate,
